...
// function that loads and prepares the shaders
void InitPipeline() {
    ...
    g_pDev->CreateVertexShader(
        VS->GetBufferPointer(),
        VS->GetBufferSize(),
        NULL,
        &g_pVS
    );
    g_pDev->CreatePixelShader(
        PS->GetBufferPointer(),
        PS->GetBufferSize(),
        NULL,
        &g_pPS
...
// function that creates the shape to render
void InitGraphics() {
...
// function that prepare graphic resources
HRESULT CreateGraphicsResources(HWND hWnd) {
    ...
    scd.Flags = DXGI_SWAP_CHAIN_FLAG_ALLOW_MODE_SWITCH; // allow full-screen switch
...
// function that render a single frame
void RenderFrame() {
